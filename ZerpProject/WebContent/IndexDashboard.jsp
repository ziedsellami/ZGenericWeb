...
<%if (session.getAttribute("user")=="Ok" ){
	
}else if (session.getAttribute("user")=="NotOk" && session.getAttribute("user")!=null){
          ...
          <ul class="sidebar-menu">
              ...
              <li class="has-sub">
                  <a href="javascript:;" class="">
                      <span class="icon-hand-down"><i class="icon-hand-down"></i></span> Article
                      <span class="arrow"></span>
                  </a>
                  <ul class="sub">
                      <li><a class="" href="ajoutarticle.jsp">Ajouter Article</a></li>
					    <li><a class="" href="operationarticle.jsp">Opération Article</a></li>
...
<!-- Mirrored from thevectorlab.net/adminlab/managed_table.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 30 Oct 2013 19:00:35 GMT -->
</html>
